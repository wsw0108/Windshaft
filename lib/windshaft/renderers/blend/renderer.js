...
Renderer.prototype.getTile = function(z, res, xmin, ymin, callback) {

    if (this.renderers.length === 1) {
        return this.renderers[0].getTile(z, res, xmin, ymin, callback);
    }
    ...
    this.renderers.forEach(function(renderer) {
        tileQueue.defer(function (z, res, xmin, ymin, done) {
            ...
            renderer.getTile(z, res, xmin, ymin, cb);
        }, z, res, xmin, ymin);
    });
